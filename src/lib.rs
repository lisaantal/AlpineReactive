// src/lib.rs
/*
 * Core library for AlpineReactive
 */
...
#[derive(Debug)]
pub struct AlpineReactiveProcessor {
    verbose: bool,
    processed_count: usize,
}

impl AlpineReactiveProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting AlpineReactive processing");
    
    let mut processor = AlpineReactiveProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = AlpineReactiveProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = AlpineReactiveProcessor::new(false);
